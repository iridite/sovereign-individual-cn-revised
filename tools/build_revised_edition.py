...
TEXT_REPLACEMENTS: dict[str, list[tuple[str, str]]] = {
    ...
    "03-chapter1.md": [
        ...
        ("[^03-chapter1-fn-21]: 译注：其实为 2000 年。", "[^03-chapter1-fn-21]: 译注：此处应为 2000 年。"),
        ("让联邦计算机为2000年做好准备", "让联邦计算机为 2000 年做好准备"),
        ("85 后的今天", "85 年后的今天"),
        ("2000年并没有那么可怕", "2000 年并没有那么可怕"),
        ("在转入2000 年之后", "在转入 2000 年之后"),
        ("在 1999 年 12月 31 日的 11：59:30 时，你打了一个一分钟的电话，在而 12 点整的时候", "在 1999 年 12 月 31 日 11:59:30 时，你打了一个一分钟的电话，而在 12 点整的时候"),
    ...
    "06-chapter4.md": [
        ...
        ("他们的整个思想体系都充斥这一种虚构", "他们的整个思想体系都充斥着一种虚构"),
    ...
    "07-chapter5.md": [
        ...
        ("其实，未来的历史学家可能会记述到，我们这一代人已经看到了第一场后现代的政变", "未来的历史学家或许会写道，我们这一代人已经看到了第一场后现代政变"),
        ("这一点大家都同意。", "对此几乎无人反对。"),
        ("很显然，福山和其他人都没有费心去问一个基本问题：", "显然，福山和其他人都没有费心追问一个基本问题："),
        ("这件事在主要的工业民主国家几乎没引起什么关注，也没得到积极的评价。", "这件事在主要的工业民主国家几乎没有引起什么关注，也没有得到积极评价。"),
        ("当藤森总统把国会送回老家时", "当藤森总统解散国会时"),
        ("然而，他的热心读者太想当然了。", "然而，他的许多热心读者把这件事看得过于理所当然了。"),
        ("但我们认为，而且我们当时也这么评价，藤森找对了路", "但我们认为，藤森当时的方向判断是正确的"),
    ],
    "08-chapter6.md": [
        ("你可以会指望", "你会指望"),
        ("环境种", "环境中"),
        ...
        ("即使到了 20 世纪80 年代", "即使到了 20 世纪 80 年代"),
        ("在 1944 提出了这个问题", "在 1944 年提出了这个问题"),
        (
        ...
        (
            "大多数失业的人如果能进通用上班，都会很开心。他们当然具备填充装配线岗位的技能；不过，你很难在诸多的当代描述中看到这一点。因为好像有一种微妙的礼节，笼罩着对工业时期劳资关系的直接分析。",
            "大多数失业者如果能进入通用上班，都会乐于接受这份工作。他们当然具备填补装配线岗位所需的能力；不过，你很难在当时的大量描述中看到这一点。仿佛存在着一种心照不宣的禁忌，笼罩着对工业时代劳资关系的直接分析。",
        ),
        ("那它只是一个不真实抽象概念。", "那它就只会沦为一个并不真实的抽象概念。"),
        ("在通用同意工会的条件时，", "在通用被迫接受工会条件时，"),
    ],
    "09-chapter7.md": [
        (
        ...
        ("圣乔治信托公司会很荣幸为你提供代办服务。", "圣乔治信托公司会很荣幸为你提供代办服务。"),
        ("其实，几乎所有的工作都会如此。", "事实上，几乎所有工作都会如此。"),
        ("**这种新的网络货币将是非国家化的**。", "**这种新的网络货币将是去国家化的**。"),
        ("只要能排上队，患者就愿意支付这样的溢价。", "只要能预约到他们，患者就愿意为此支付这样的溢价。"),
        ("### 复利的黑魔法", "### 复利的魔力"),
        ("当复利的黑魔法在高税率国家的成功人士心中变得愈发清晰，", "当复利的魔力在高税率国家的成功人士心中变得愈发清晰，"),
    ],
    "10-chapter8.md": [
        ("在19 世纪末", "在 19 世纪末"),
        ("这个例子其实也很好地说明了", "这个例子也很好地说明了"),
        ("中央银行的高负债率", "中央政府的高负债率"),
        ...
        ("如果某地区的法规下使渲染厂的经营成本很高，甚至无法盈利，渲染厂就可能会搬到其他地区，但这并不使该地区的总体收入减少。", "如果某地区的法规使渲染厂的经营成本高到无利可图，渲染厂就可能搬往其他地区，但这并不一定会减少该地区的总体收入。"),
        ("“所谓的社会金字塔结构，它真正的形式其实是一个扁平的洋葱或萝卜。”", "“所谓的社会金字塔结构，其真实形态更像一颗被压扁的洋葱或萝卜。”"),
        ("掌握创业、投资等特殊技能的高端人才", "掌握创业、投资等特殊技能的人"),
        ("掌握创业、投资等特殊技能的精英人才", "掌握创业、投资等特殊技能的人"),
    ],
    "11-chapter9.md": [
        ("“智能炸弹客”", "“独行炸弹客”"),
        ("特急葡萄酒", "顶级波尔多红酒"),
        ...
        ("[^11-chapter9-fn-13]: Patriot,这里翻译成爱国者其实不太妥。", "[^11-chapter9-fn-13]: 译注：此处的 patriot 更接近“捍卫乡土共同体者”，并非现代民族国家语境中的“爱国者”。"),
        ("经合 组织", "经合组织"),
        ("语言统 一", "语言统一"),
        ("很显然，他们没能证明", "显然，他们没能证明"),
        ("哪种倾向会付出水面呢？", "哪种倾向会浮出水面呢？"),
        ("10%的收益", "10% 的收益"),
        ("20%的收益", "20% 的收益"),
        ("每年缴纳5000 美元", "每年缴纳 5000 美元"),
        ("税率就是10%。", "税率就是 10%。"),
        ...
        ("认为信息精英们超越地方专政、抛弃“未开窍者”是“背叛”。", "认为信息精英们超越地方专制、抛弃“未开窍者”是一种“背叛”。"),
        ("自由市场并没有被摧毁，而是胜利地离开了。", "自由市场并没有被摧毁，反而是在胜利中脱身而去。"),
        ("借此索求财务往往都可以得逞。", "借此索求财物，往往都可以得逞。"),
        ("使用暴力、控制暴力的行业是一种天然性的垄断", "使用暴力、控制暴力的行业是一种天然垄断"),
        ("更加不经济。 莱恩的评论在两个方面具有参考价值。", "更加不经济。莱恩的评论在两个方面具有参考价值。"),
        ("对他们的批评背后，其实隐藏着一个认知，", "对他们的批评背后，其实隐含着一种判断，"),
        ("恰恰相反他们很懂算术。", "恰恰相反，他们很懂算术。"),
        ("他们对市场深化的各种结果非常反对，更不要说主权个人的去国家化了。", "他们强烈反对市场深化带来的种种结果，更不用说主权个人的去国家化了。"),
    ],
    "12-chapter10.md": [
        (
        ...
        ("当然，香港从来也不是一个民主国家。其实，它是我们希望看到的那种能在信息时代蓬勃发展的管辖区模型。", "当然，香港从来不是一个民主国家。事实上，它正是我们希望在信息时代看到的那种能够蓬勃发展的管辖区模型。"),
        ("外国科学家在美国工作", "外国数学家在美国工作"),
        ("### 电子投票", "### 电子公决"),
        ("电子投票。全体公民", "电子公决。全体公民"),
        ("50 平米公里", "50 平方公里"),
        ("很显然，如果信息经济中的收入差距大到惊人，那么民主就只是一种披着合法外衣的寄生主义。", "如果信息经济中的收入差距大到惊人，那么民主就只会沦为一种披着合法外衣的寄生主义。"),
        ...
        ("在很多方面都是一位开拓者。", "在许多方面都堪称开拓者。"),
        ("其质量会得到大幅度的提高。", "其生活质量会显著提高。"),
        ("你可以推出自己的专属小国，像中世纪所有的公爵一样享有独立的地位。", "你可以建立自己的专属小国，像中世纪所有公爵那样享有独立地位。"),
        ("选民们会看到，在大众民主的束缚下他们其实是在受苦。", "选民们会看到，自己在大众民主的束缚下其实一直在受苦。"),
        ("这些问题其实可以在瞬间内解决。", "这些问题完全可以在瞬间解决。"),
        ("这其实只是古希腊抽签选拔制度的现代版本。", "这不过是古希腊抽签选拔制度的现代版本。"),
        ("有一些公共产品其实是变相的私人用品。", "有一些所谓的公共产品，实际上是变相的私人用品。"),
        ("这里的“公共开支”是一种委婉的说法，其实是“以纳税人为代价”。", "这里所谓的“公共开支”只是一种委婉说法，说到底仍是“以纳税人为代价”。"),
        ("很显然，一个政府如果不能无限制地没收公民的收入和财产", "显然，一个政府如果不能无限制地没收公民的收入和财产"),
        ("这些问题完全可以在瞬间解决。代表没必要经由选举产生，完全可以通过随机的分类挑选出来，", "这些问题本可在极短时间内解决。代表也未必必须经由选举产生，完全可以通过随机分类挑选出来，"),
        ("这根本就是不可能的，不管是由于竞争还是其他原因。", "这种说法其实并不成立，无论是从竞争逻辑还是其他角度来看都是如此。"),
        ("可能会确凿地证明专有管理", "很可能会有力地证明专有管理"),
        ("它还确凿地证明了，大政府的辩护者经常讴歌的大众生活，", "它也有力地证明了，大政府的辩护者经常讴歌的大众生活，"),
        ("它也有力地证明了，大政府的辩护者经常讴歌的大众生活，在阿吉雷发起的自由贸易区带来的经济繁荣下，其生活质量会显著提高。", "它也有力地表明，在阿吉雷发起的自由贸易区所带来的经济繁荣下，那种常被大政府辩护者讴歌的大众生活，其生活质量同样会显著提高。"),
        ("多数人可能会愿意，甚至很高兴抛弃掉政治的闹剧，", "多数人甚至可能乐于抛开这场政治闹剧，"),
    ],
    "13-chapter11.md": [
        ...
        ("参观美术馆等等。", "参观美术馆之类的地方。"),
        ("在人的道德生活中，最深层的差别其实是轻松和紧张的状态差别。", "在人的道德生活中，最深层的区别，在于人究竟处于轻松还是紧张的精神状态。"),
        ("银行里有足够的钱，等等。", "银行里有足够的钱，诸如此类。"),
        ("荣格做了诊断，认为其实是他的创造力没有了出口，", "荣格做了诊断，认为问题其实在于他的创造力失去了出口，"),
    ],
    "14-afterword.md": [
    ...
    "16-appendix2.md": [
        ...
        ("他们联合起来，帮助彼此以实现独立。", "他们联合起来，帮助彼此以实现独立。"),
        ...
        ("如果你喜欢本书，你可能也会喜欢阅读《战略投资》", "如果你喜欢本书，你可能也会喜欢阅读《战略投资》"),
        ...
        ("《战略投资》就已经告诉了读者该如何应对。", "《战略投资》就已经告诉了读者该如何应对。"),
        ("另外，请登录战略投资网站浏览 http://www.strategicinvestment.com。", "另外，请登录战略投资网站浏览 http://www.strategicinvestment.com。"),
        ("普通会员资格是每年 295美元。", "普通会员资格为每年 295 美元。"),
        ("如果你想与詹姆斯·戴尔·戴维森和里斯·莫格勋爵一起，参加新兴机遇之地的替代性住所和生活方式之旅，请联系丽莎·伊登，电话：888-281-8250。", "如果你想与詹姆斯·戴尔·戴维森和里斯·莫格勋爵一起，参加新兴机遇之地的替代性住所和生活方式之旅，请联系丽莎·伊登，电话：888-281-8250。"),
        ("就为高端客户提供最高质量的私人服务。", "就为高端客户提供最高质量的私人服务。"),
        ("圣乔治公司提供创新、定制和跨国的服务。", "圣乔治公司提供创新、定制和跨国的服务。"),
    ],
    "15-appendix.md": [
        ("# 附录1：影响和战略", "# 附录一：影响和战略"),
